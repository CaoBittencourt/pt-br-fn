...
\begin{bilingualpages}
    ...
    \section{Vogays}
    Comu aludjidu asima, as vogays na llĩgwa brazileyra sà\~w ``a'', ``e'', ``i'', ``o'', ``u''; i as semivogays, ``y'' i ``w'' (``Cwazi-i'' i ``Cwazi-u''). As vogays fóhrmà\~w iatus si adjijase\~ytxis, mas as semivogays aglutxínà\~w-si.
