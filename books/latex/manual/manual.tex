...
\begin{bilingualpages}
    ...
    Desse modo, se não indicado por acento, são oxítonas (e não acentuadas) todas as palavras terminadas em: ``hr'', ``e", ``o", ``w", ``y", ``o\~y", ``o\~w" (e, igualmente, os plurais, acrescidos de ``s'' no final).
