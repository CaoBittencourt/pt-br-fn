...
\begin{bilingualpages}
    ...
    A grafia adotada para esse último fonema no português brasileiro fonético é ``lly''. Nisso, assemelha-se às línguas espanhola e francesa, que escrevem a aproximante lateral palatal com o dígrafo ``ll'' (e.g. [exemplo], [exemplo]).
