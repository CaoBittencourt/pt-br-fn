...
\begin{bilingualpages}
    ...
    [falar da remoção do ``l'' pós-vocálico, citar um exemplo em alemão, onde o ``l'' pós-vocálico é pronunciado]
    ...
    A grafia adotada para esse último fonema (viz. [\textsubbar{l}\textsuperscript{j}]) no português brasileiro fonético é ``lly''. Nisso, assemelha-se às línguas espanhola e francesa, que escrevem a aproximante lateral palatal com o dígrafo ``ll'' (e.g. [exemplo], [exemplo]).
