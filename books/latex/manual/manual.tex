...
\begin{bilingualpages}
    ...
    Temos na língua brasileira apenas palavras oxítonas, paroxítonas e proparoxítonas, cujas sílabas tônicas são, respectivamente, a última, a penúltima e a antipenúltima.
    ...
    As oxítonas, por sua vez, são relativamente comuns, mas nem sempre requerem acento. Isso porque há alguns padrões consistentes em nossa língua, que nos permitem identificá-las. Desse modo, se não indicado por acento, são oxítonas (e não acentuadas) todas as palavras terminadas em: ``hr'', ``e", ``o", ``w", ``y", ``o\~y", ``o\~w" (idem os plurais).

    acentos tônicos e átonos. lista e hierarquia dos acentos.

    % \subsubsection{Diferenciação de homófonas}
