...
\subsubsection{Os novos acentos nasais}
% \subsubsection{Nasalização e acentuação}
Feitas essas ressalvas, os acentos, ainda conservam a função de indicar pronúncia alternativa. E, aliás, tratando-se dos acentos nasais, essa função não é nem sequer secundária.
