...
Conforme as tabelas, o novo alfabeto brasileiro (à esquerda) tem vinte e quatro letras, enquanto o antigo alfabeto português-brasileiro (à direita) tem vinte e seis. As letras removidas foram o ``k'' e o ``q'', porque são redundantes. De fato, a primeira delas já era até na antiguidade clássica criticada pelos gramáticos romanos, que achavam-na desnecessária. A letra ``q'', por sua vez, foi uma invenção desses mesmos gramáticos para diferenciar o som do ``u'' vogal [u] e do ``u'' semivogal [w] (cf. as palavras \textit{qui} [kwi] e \textit{cui} [ku\textprimstress i]).

Esse mecanismo, no entanto, é evidentemente rudimentar --- como outras [\textprimstress owtras] de suas invenções (e.g. os algarismos {[awga\textprimstress \textfishhookr ismus]} romanos) ---, pois [pojs] não [n\~\textturna\~w] permite distinguir entre vogais [vo\textprimstress gajs] e semivogais nas palavras sem ``q'', tampouco [t\~\textturna\~w\textprimstress powku] nas de ``i'' semivocálico [j], muito [\textprimstress mu\~\j tu] frequentes em nossa língua [\textprimstress\textll ĩgwa]. Além disso, na maioria das palavras brasileiras \textit{com} [ko\~w] ``q'' o ``u'' não é nem [ne\~\j] sequer [si\textprimstress k\textepsilon h] semivogal, mas mudo e inexistente. Assim sendo, removemos do alfabeto aquela [a\textprimstress k\textepsilon la] letra, desprezada pelos romanos, e, ironicamente, também essa, que [ki] inventaram.
