...
\\
        {[}\textprimstress tive \textprimstress nauzea no ko\textprimstress l\textepsilon \textyogh io! \textprimstress dame um \textprimstress k\textopeno po \textprimstress dagua e va a fa\textfishhookr \textprimstress masia com\textprimstress p\textfishhookr a\textfishhookr me he\textprimstress m\textepsilon dio{]}\footnote{
            O que pronunciaríamos {[}\textprimstress txivi \textprimstress nawzja nu ko\textprimstress l\textepsilon \textyogh ju! \textprimstress dami ũ \textprimstress k\textopeno po \textprimstress dagwa i va a fah\textprimstress masja co\~w\textprimstress p\textfishhookr ahmi he\textprimstress m\textepsilon \texttoptiebar{d\textyogh}ju{]}.
        }.
    \end{tabularx}
\end{center}
...
Os nordestinos, por assim dizer, recitam o silabário corretamente, enquanto os demais trocam o ``li'' por ``lhi'', dizendo: ``la'' [la], ``le'' [le], ``lhi'' [\textsubbar{l}\textsuperscript{j}i], ``lo'' [lo], ``lu'' [lu]. E o mesmo vale para o ``di'' e o ``ti'' (pronunciados ``dji'' [\texttoptiebar{d\textyogh}i] e ``txi'' [\texttoptiebar{t\textesh}i] pela grande maioria dos brasileiros). Com isso, é certo que o ``l'', o ``d'' e o ``t'', seguidos de ``i'' ou ``y'' devem ser novos dígrafos.
...
O primeiro fonema é comum nas regiões litorâneas, desde o Nordeste, ao Rio de Janeiro, chegando até à capital de Santa Catarina. O segundo encontra-se entre os paulistas e sulistas (principalmente gaúchos). E o restante do país utiliza o ``r'' ``caipira'' [\textturnr], a aproximante alveolar sonora, ou o omite inteiramente\footnote{
