...
\subsubsection{Os novos acentos da língua brasileira}
% \subsubsection{Nasalização e acentuação}
Feitas essas ressalvas, os acentos, ainda conservam a função de indicar pronúncia alternativa. E, dependendo do acento, essa função nem sequer é secundária.
%  E, aliás, tratando-se dos acentos nasais, essa função não é nem sequer secundária.
