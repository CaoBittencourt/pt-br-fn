...
Analogamente, a letra ``g'' perde uma de suas funções e é renomeada para ``Gá'' [ga] para que seja melhor representada. Esse novo nome é mais adequado, pois o ``Gê'' [\textyogh e] carregava consigo certa ambiguidade, devido à sua pronúncia no português-brasileiro, enquanto que todos -- até os falantes de outros idiomas -- concordam que ``g'' seguido de ``a'' pronuncia-se com a consoante oclusiva velar sonora [g], e não com o ``j'' francês. Assim, por exemplo, a palavra ``garagem'' [gara\textprimstress\textyogh\texttoptiebar{e\~\j}], antes escrita com dois ``g'', é, agora explicitamente, ``garaje\~y''.
% Analogamente, a letra ``g'' foi renomeada para ``Gá'' [ga], pois o antigo nome, ``Gê'' [\textyogh e], carregava consigo certa ambiguidade, pela sua pronúncia no português-brasileiro. No entanto, todos -- até os falantes de outros idiomas -- concordam que ``g'' seguido de ``a'' pronuncia-se [ga], com a consoante oclusiva velar sonora [g], e não com o ``j'' francês. Assim, por exemplo, a palavra ``garagem'' [gara\textprimstress\textyogh\texttoptiebar{e\~\j}], antes escrita com dois ``g'', torna-se, explicitamente, ``garaje\~y''.
