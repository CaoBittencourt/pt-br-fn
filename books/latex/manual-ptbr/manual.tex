...
O primeiro fonema é comum nas regiões litorâneas, desde o Nordeste, ao Rio de Janeiro, chegando até à capital de Santa Catarina. O segundo encontra-se entre os paulistas e sulistas (principalmente gaúchos). E o restante do país utiliza o ``r'' ``caipira'' [\textturnr], a aproximante alveolar sonora, ou o omite inteiramente.
