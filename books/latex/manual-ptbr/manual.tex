...
nisso difere bastante de como costumava ser. Na língua brasileira, o acento
...
ao ``n'' ou ``m'', como é no espanhol ou no italiano, onde a consoante é pronunciada, mas daquele som nasal \textit{não consonantal}, que é marca do português brasileiro:
\\
\par exemplo [IPA];
\par exemplo [IPA];
\par exemplo [IPA];
