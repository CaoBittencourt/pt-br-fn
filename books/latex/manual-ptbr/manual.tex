...
Apesar de essas funções serem iguais às de antes, os diacríticos, em si, mudaram significativamente, excetuando-se o acento agudo. Esse, por sua vez, tem agora uma contraparte ``mais simétrica'' no acento grave (ao invés do circunflexo). Com isso, o acento ``ascendente'' denota vogais abertas e o ``descendente'', vogais fechadas (trata-se do exato oposto do italiano, do francês e do espanhol).
