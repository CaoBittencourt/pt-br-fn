...
Analogamente, a letra ``g'' representa, agora, apenas a consoante oclusiva velar sonora [g] e, como o ``c'', foi renomeada para ``Gá'' [ga], uma vez que o nome ``Gê''
...
exemplo, a palavra ``garagem'' [gara\textprimstress\textyogh\texttoptiebar{e\~\j}], antes escrita com dois ``g'', torna-se, explicitamente, ``garaje\~y''.
