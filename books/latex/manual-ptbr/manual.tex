...
O último dígrafo a comentar é o ``hr'', ou ``r'' pós-vocálico. Também ausente no português, esse foi adicionado ao idioma brasileiro para expressar todas as maneiras com que pronunciamos o ``r'' depois de vogal (seguido de consoante). E, ao contrário do antigo (mal) uso do ``h'', o ``hr'' é um verdadeiro ``dígrafo coringa'', pois pode ser pronunciado como ``h'' (gutural), ``r'' (tepe alveolar), ambos ou nenhum.

O primeiro fonema é comum nas regiões litorâneas, desde o Nordeste, ao Rio de Janeiro, chegando até à capital de Santa Catarina. O segundo prevalece entre os paulistas e sulistas, principalmente os gaúchos. E o restante do país utiliza um ``r'' retroflexo (i.e. o ``r'' de ``caipira'') ou o omite inteiramente.


% esse, mais do que ``lly'', suscita-nos 
% O último dígrafo a comentar é o ``hr''; e, mais do que o ``lly'', suscita uma certa ``consciência nacional'', pois o único motivo para existir é harmonizar as diversas maneiras com que os brasileiros pronunciam o ``r'' pós-vocálico.
